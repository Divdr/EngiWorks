...
<!-- Mirrored from www.vasterad.com/themes/hireo_082019/dashboard-messages.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Feb 2020 19:11:16 GMT -->
<head>
				...
				<div class="dashboard-nav">
					<div class="dashboard-nav-inner">
						...
						<ul data-submenu-title="Start">
							<li><a href="dashboard.php"><i class="icon-material-outline-dashboard"></i> Dashboard</a></li>
							<li class="active"><a href="dashboard-messages.php"><i class="icon-material-outline-question-answer"></i> Messages <span class="nav-tag">2</span></a></li>
