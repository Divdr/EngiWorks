...
<!-- Mirrored from www.vasterad.com/themes/hireo_082019/single-task-page.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Feb 2020 19:10:50 GMT -->
<head>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="single-page-header-inner">
					<div class="left-side">
						<div class="header-image"><a href="single-company-profile.php"><img src="images/browse-companies-02.png" alt=""></a></div>
						<div class="header-details">
							<h3>Food Delivery Mobile Application</h3>
							<h5>About the Employer</h5>
							<ul>
								<li><a href="single-company-profile.php"><i class="icon-material-outline-business"></i> Acue</a></li>
				...
				<ul class="boxed-list-ul">
						...
						<div class="bid">
							...
							<div class="bids-avatar">
								<div class="freelancer-avatar">
									...
									<a href="single-freelancer-profile.php"><img src="images/user-avatar-big-01.jpg" alt=""></a>
								</div>
							</div>
							...
							<div class="bids-content">
								...
								<div class="freelancer-name">
									<h4><a href="single-freelancer-profile.php">Tom Smith <img class="flag" src="images/flags/gb.svg" alt="" title="United Kingdom" data-tippy-placement="top"></a></h4>
					...
					<li>
						<div class="bid">
							...
							<div class="bids-avatar">
								<div class="freelancer-avatar">
									<div class="verified-badge"></div>
									<a href="single-freelancer-profile.php"><img src="images/user-avatar-big-02.jpg" alt=""></a>
								</div>
							</div>
							...
							<div class="bids-content">
								<!-- Name -->
								<div class="freelancer-name">
									<h4><a href="single-freelancer-profile.php">David Peterson <img class="flag" src="images/flags/de.svg" alt="" title="Germany" data-tippy-placement="top"></a></h4>
					...
					<li>
						<div class="bid">
							...
							<div class="bids-avatar">
								<div class="freelancer-avatar">
									<a href="single-freelancer-profile.php"><img src="images/user-avatar-placeholder.png" alt=""></a>
								</div>
							</div>
							...
							<div class="bids-content">
								<!-- Name -->
								<div class="freelancer-name">
									<h4><a href="single-freelancer-profile.php">Marcin Kowalski <img class="flag" src="images/flags/pl.svg" alt="" title="Poland" data-tippy-placement="top"></a></h4>
					...
					<li>
						<div class="bid">
							...
							<div class="bids-content">
								<!-- Name -->
								<div class="freelancer-name">
									<h4><a href="single-freelancer-profile.php">Sebastiano Piccio <img class="flag" src="images/flags/it.svg" alt="" title="Italy" data-tippy-placement="top"></a></h4>
...
<!-- Mirrored from www.vasterad.com/themes/hireo_082019/single-task-page.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Feb 2020 19:10:51 GMT -->
</html>