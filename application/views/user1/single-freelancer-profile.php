...
<!-- Mirrored from www.vasterad.com/themes/hireo_082019/single-freelancer-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Feb 2020 19:11:06 GMT -->
<head>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="single-page-header-inner">
					<div class="left-side">
						<div class="header-image freelancer-avatar"><img src="<?=base_url("resources/user/images/userprofilespics/".$userdata[0]->profilepic)?>" alt=""></div>
						<div class="header-details">
							<h3><?= $userdata[0]->enginame?> <span><?= $userdata[0]->catagories?></span></h3>
							<ul>
								<li><div class="star-rating" data-rating="5.0"></div></li>
								<li><img class="flag" src="images/flags/de.svg" alt=""> <?= $userdata[0]->city?></li>
...
<!-- Mirrored from www.vasterad.com/themes/hireo_082019/single-freelancer-profile.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Feb 2020 19:11:12 GMT -->
</html>