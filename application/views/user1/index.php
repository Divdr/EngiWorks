		...
		<div class="row">
			<div class="col-xl-12">
				...
				<div class="categories-container">
					...
					<!-- Category Box -->
					<a href="jobs-grid-layout-full-page.php" class="category-box">
					...
					<!-- Category Box -->
					<a href="jobs-list-layout-full-page-map.php" class="category-box">
						<div class="category-box-icon">
					...
					<!-- Category Box -->
					<a href="jobs-list-layout-1.php" class="category-box">
						<div class="category-box-icon">
					...
					<!-- Category Box -->
					<a href="jobs-list-layout-2.php" class="category-box">
						<div class="category-box-icon">
		...
		<div class="row">
			<div class="col-xl-12">
				...
				<div class="listings-container compact-list-layout margin-top-35">
					...
					<!-- Job Listing -->
					<a href="single-job-page.php" class="job-listing with-apply-button">
						...
						<div class="job-listing-details">
							...
							<div class="job-listing-company-logo">
								<img src="<?php echo base_url("resources/user/") ?>images/company-logo-01.png" alt="">
							</div>
					...
					<a href="single-job-page.php" class="job-listing with-apply-button">
						...
						<div class="job-listing-details">
							...
							<!-- Logo -->
							<div class="job-listing-company-logo">
								<img src="<?php echo base_url("resources/user/") ?>images/company-logo-05.png" alt="">
							</div>
					...
					<a href="single-job-page.php" class="job-listing with-apply-button">
						...
						<div class="job-listing-details">
							...
							<!-- Logo -->
							<div class="job-listing-company-logo">
								<img src="<?php echo base_url("resources/user/") ?>images/company-logo-02.png" alt="">
							</div>
					...
					<a href="single-job-page.php" class="job-listing with-apply-button">
						...
						<div class="job-listing-details">
							...
							<!-- Logo -->
							<div class="job-listing-company-logo">
								<img src="<?php echo base_url("resources/user/") ?>images/company-logo-03.png" alt="">
							</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-list-layout-1.php" class="photo-box" data-background-image="<?php echo base_url("resources/user/") ?>images/featured-city-01.jpg">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-list-layout-full-page-map.php" class="photo-box" data-background-image="<?php echo base_url("resources/user/") ?>images/featured-city-02.jpg">
					<div class="photo-box-content">
						<h3>New York</h3>
						<span>645 Jobs</span>
					</div>
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-grid-layout-full-page.php" class="photo-box" data-background-image="<?php echo base_url("resources/user/") ?>images/featured-city-03.jpg">
					<div class="photo-box-content">
						<h3>Los Angeles</h3>
						<span>832 Jobs</span>
					</div>
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-list-layout-2.php" class="photo-box" data-background-image="<?php echo base_url("resources/user/") ?>images/featured-city-04.jpg">
					<div class="photo-box-content">
						<h3>Miami</h3>
						<span>513 Jobs</span>
					</div>
				...
				<div class="default-slick-carousel freelancers-container freelancers-grid-layout">
						...
						<div class="freelancer-overview">
							<div class="freelancer-overview-inner">
								...
								<div class="freelancer-avatar">
									...
									<a href="single-freelancer-profile.php"><img src="<?php echo base_url("resources/user/") ?>images/user-avatar-big-01.jpg" alt=""></a>
								</div>

								<!-- Name -->
								<div class="freelancer-name">
									<h4><a href="single-freelancer-profile.php">Tom Smith <img class="flag" src="<?php echo base_url("resources/user/") ?>images/flags/gb.svg" alt="" title="United Kingdom" data-tippy-placement="top"></a></h4>
					...
					<div class="freelancer">
						...
						<div class="freelancer-overview">
							<div class="freelancer-overview-inner">
								...
								<div class="freelancer-avatar">
									<div class="verified-badge"></div>
									<a href="single-freelancer-profile.php"><img src="<?php echo base_url("resources/user/") ?>images/user-avatar-big-02.jpg" alt=""></a>
								</div>

								<!-- Name -->
								<div class="freelancer-name">
									<h4><a href="#">David Peterson <img class="flag" src="<?php echo base_url("resources/user/") ?>images/flags/de.svg" alt="" title="Germany" data-tippy-placement="top"></a></h4>
					...
					<div class="freelancer">
						...
						<div class="freelancer-overview">
							<div class="freelancer-overview-inner">
								...
								<!-- Avatar -->
								<div class="freelancer-avatar">
									<a href="single-freelancer-profile.php"><img src="<?php echo base_url("resources/user/") ?>images/user-avatar-placeholder.png" alt=""></a>
								</div>

								<!-- Name -->
								<div class="freelancer-name">
									<h4><a href="#">Marcin Kowalski <img class="flag" src="<?php echo base_url("resources/user/") ?>images/flags/pl.svg" alt="" title="Poland" data-tippy-placement="top"></a></h4>
					...
					<div class="freelancer">
						...
						<div class="freelancer-overview">
								...
								<div class="freelancer-avatar">
									<div class="verified-badge"></div>
									<a href="single-freelancer-profile.php"><img src="<?php echo base_url("resources/user/") ?>images/user-avatar-big-03.jpg" alt=""></a>
								</div>

								<!-- Name -->
								<div class="freelancer-name">
									<h4><a href="#">Sindy Forest <img class="flag" src="<?php echo base_url("resources/user/") ?>images/flags/au.svg" alt="" title="Australia" data-tippy-placement="top"></a></h4>
					...
					<div class="freelancer">
						...
						<div class="freelancer-overview">
								...
								<!-- Name -->
								<div class="freelancer-name">
									<h4><a href="#">Sebastiano Piccio <img class="flag" src="<?php echo base_url("resources/user/") ?>images/flags/it.svg" alt="" title="Italy" data-tippy-placement="top"></a></h4>
					...
					<div class="freelancer">
						...
						<div class="freelancer-overview">
								...
								<!-- Name -->
								<div class="freelancer-name">
									<h4><a href="#">Gabriel Lagueux <img class="flag" src="<?php echo base_url("resources/user/") ?>images/flags/fr.svg" alt="" title="France" data-tippy-placement="top"></a></h4>
