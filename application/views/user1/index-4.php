...
<!-- Mirrored from www.vasterad.com/themes/hireo_082019/index-3.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Feb 2020 19:10:08 GMT -->
<head>
			...
			<div class="col-md-12">
				<div class="intro-banner-search-form margin-top-95">
					...
					<div class="intro-search-button">
						<button class="button ripple-effect" onclick="window.location.href='jobs-list-layout-1.php'">Search</button>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-6 col-md-8 col-sm-12">
					...
					<a href="pages-pricing-plans.php" class="button button-sliding-icon ripple-effect big margin-top-20">Get Started <i class="icon-material-outline-arrow-right-alt"></i></a>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-xl-12">
				...
				<div class="section-headline margin-top-0 margin-bottom-45">
					<h3>From The Blog</h3>
					<a href="pages-blog.php" class="headline-link">View Blog</a>
				</div>

				<div class="row">
					<!-- Blog Post Item -->
					<div class="col-xl-4">
						<a href="pages-blog-post.php" class="blog-compact-item-container">
...
<!-- Mirrored from www.vasterad.com/themes/hireo_082019/index-3.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Feb 2020 19:10:40 GMT -->
</html>