...
<!-- Mirrored from www.vasterad.com/themes/hireo_082019/dashboard-manage-jobs.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Feb 2020 19:11:16 GMT -->
<head>
...
<!-- 											<a href="#" class="job-listing-company-logo">
									...
									<div class="buttons-to-right always-visible">
										<a href="dashboard-manage-candidates.php" class="button ripple-effect"><i class="icon-material-outline-supervisor-account"></i> Manage Candidates <span class="button-info">0</span></a>
								...
								<li>
									...
									<!-- Buttons -->
									<div class="buttons-to-right always-visible">
										<a href="dashboard-manage-candidates.php" class="button ripple-effect"><i class="icon-material-outline-supervisor-account"></i> Manage Candidates <span class="button-info">3</span></a>
										<a href="#" class="button gray ripple-effect ico" title="Edit" data-tippy-placement="top"><i class="icon-feather-edit"></i></a>
										<a href="#" class="button gray ripple-effect ico" title="Remove" data-tippy-placement="top"><i class="icon-feather-trash-2"></i></a>
									</div>
								</li>
								...
								<li>
									...
									<!-- Buttons -->
									<div class="buttons-to-right always-visible">
										<a href="dashboard-manage-candidates.php" class="button ripple-effect"><i class="icon-material-outline-supervisor-account"></i> Manage Candidates <span class="button-info">7</span></a>
