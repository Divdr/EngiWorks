...
<!-- Mirrored from www.vasterad.com/themes/hireo_082019/index-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Feb 2020 19:09:56 GMT -->
<head>
	...
	<div id="header">
		<div class="container">
			...
			<div class="left-side">
				...
				<!-- Logo -->
				<div id="logo">
					<a href="index-2.php"><img src="images/logo2.png" data-sticky-logo="images/logo.png" data-transparent-logo="images/logo2.png" alt=""></a>
				</div>
			...
			<div class="col-md-12">
				<div class="intro-banner-search-form margin-top-95">
					...
					<div class="intro-search-button">
						<button class="button ripple-effect" onclick="window.location.href='freelancers-grid-layout-full-page.php'">Search</button>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-list-layout-1.php" class="photo-box small" data-background-image="images/job-category-01.jpg">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-list-layout-full-page-map.php" class="photo-box small" data-background-image="images/job-category-02.jpg">
					<div class="photo-box-content">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-grid-layout-full-page.php" class="photo-box small" data-background-image="images/job-category-03.jpg">
					<div class="photo-box-content">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-list-layout-2.php" class="photo-box small" data-background-image="images/job-category-04.jpg">
					<div class="photo-box-content">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-list-layout-1.php" class="photo-box small" data-background-image="images/job-category-05.jpg">
					<div class="photo-box-content">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-list-layout-full-page-map.php" class="photo-box small" data-background-image="images/job-category-06.jpg">
					<div class="photo-box-content">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-grid-layout-full-page.php" class="photo-box small" data-background-image="images/job-category-07.jpg">
					<div class="photo-box-content">
			...
			<div class="col-xl-3 col-md-6">
				<!-- Photo Box -->
				<a href="jobs-list-layout-2.php" class="photo-box small" data-background-image="images/job-category-08.jpg">
					<div class="photo-box-content">
		...
		<div class="row">
			<div class="col-xl-12">
				...
				<div class="section-headline margin-top-0 margin-bottom-35">
					<h3>Recent Tasks</h3>
					<a href="tasks-list-layout-1.php" class="headline-link">Browse All Tasks</a>
				</div>
				...
				<div class="tasks-list-container compact-list margin-top-35">
					...
					<!-- Task -->
					<a href="single-task-page.php" class="task-listing">
...
<script src="js/jquery-migrate-3.1.0.min.php"></script>
...
<!-- Mirrored from www.vasterad.com/themes/hireo_082019/index-2.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Feb 2020 19:10:08 GMT -->
</html>