...
<!-- Mirrored from www.vasterad.com/themes/hireo_082019/dashboard-reviews.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Feb 2020 19:11:16 GMT -->
<head>
				...
				<div class="dashboard-nav">
					<div class="dashboard-nav-inner">
						...
						<ul data-submenu-title="Start">
							...
							<li class="active"><a href="dashboard-reviews.php"><i class="icon-material-outline-rate-review"></i> Reviews</a></li>
						</ul>
