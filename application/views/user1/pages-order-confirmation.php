...
<!-- Mirrored from www.vasterad.com/themes/hireo_082019/pages-order-confirmation.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Feb 2020 19:13:03 GMT -->
<head>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="order-confirmation-page">
				...
				<a href="pages-invoice-template.php" class="button ripple-effect-dark button-sliding-icon margin-top-30">View Invoice <i class="icon-material-outline-arrow-right-alt"></i></a>
			</div>
