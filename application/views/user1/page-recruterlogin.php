		...
		<div class="col-xl-5 offset-xl-3">
			...
			<div class="login-register-page">
				...
				<div class="welcome-text">
					...
					<span>Do You want to Login as a User <a href="<?= site_url("user/UserLogin/loadUserLogin/")?>">Sign In!</a></span>
				</div>
					
				<!-- Form -->
				<form method="post" id="login-form" action="<?= site_url("recruter/RecruterLogin/validaterecruter/")?>">
