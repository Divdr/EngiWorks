...
<!-- Mirrored from www.vasterad.com/themes/hireo_082019/pages-user-interface-elements.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Feb 2020 19:12:08 GMT -->
<head>
							...
							<div class="mega-menu mobile-styles three-columns">
									...
									<div class="mega-menu-section">
										<ul>
											...
											<li><a href="pages-user-profile.php"><i class="sl sl-icon-user"></i>Item #1</a></li>
											<li><a href="pages-user-profile.php"><i class="sl sl-icon-user"></i>Item #2</a></li>
											<li><a href="pages-user-profile.php"><i class="sl sl-icon-user"></i>Item #3</a></li>
											<li><a href="pages-user-profile.php"><i class="sl sl-icon-user"></i>Item #4</a></li>
										</ul>
									</div>
...
<div class="container">
	<div class="row">
		...
		<div class="col-xl-12">
			...
			<div class="notification notice closeable">
				<p>Select boxes are powered by <strong>Bootstrap Select</strong>. More examples at <a href="https://silviomoreto.github.io/bootstrap-select/examples/">http://silviomoreto.github.io/bootstrap-select/examples/</a></p>
				<a class="close" href="#"></a>
			</div>
		</div>
...
<!-- Mirrored from www.vasterad.com/themes/hireo_082019/pages-user-interface-elements.php by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 16 Feb 2020 19:12:09 GMT -->
</html>