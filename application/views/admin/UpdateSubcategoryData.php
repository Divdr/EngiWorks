...
<form method="post" action="<?php echo site_url('admin/SubCategory/UpdateSubCatData/'.$SubCatData[0]->SkillID) ?>">		
													<table class="table table-hover">
														<thead>
															
															<tr>
																<th>CATEGORY NAME</th>
<th><input name="txtSubCatName" value="<?php echo $SubCatData[0]->SkillName ?>"></th>
															<tr>
																<th>STATUS</th>
<th><input name="txtSubCatStatus" value="<?php echo $SubCatData[0]->Status ?>"></th>
