...
<td>
<a href="<?php echo site_url('admin/SubCategory/listincat/'.$c->CategoryID) ?>">SUB-CATEGORYES</a>																
</td>
<td>
	<a href="<?= site_url('admin/admin/toggalstatus/') .$c->CategoryID."/".$c->Status ?>">
	<?php
	if ($c->Status==0) 
	{
		echo "ACTIVE";
...
<th><a href="<?php echo site_url('admin/admin/deletedata/'.$c->CategoryID )?>">DELETE</a></th>

<th><a href="<?php echo site_url('admin/admin/loadupdatedata/'.$c->CategoryID )?>">UPDATE</a></th>
