...
<form method="post" action="<?php echo site_url('admin/AdminState/UpdateStateData/'.$statdata[0]->StateID)."/".$statdata[0]->CountryID ?>">		
													<table class="table table-hover">
														<thead>
															
															<tr>
																<th>COUNTRY NAME</th>
<th><input name="txtstatname" value="<?= $statdata[0]->StateName?>"></th>
																<th align="center">
