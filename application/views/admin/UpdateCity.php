...
<form method="post" action="<?php echo site_url('admin/AdminCity/UpdateCityData/'.$citydata[0]->CityID)."/".$citydata[0]->StateID ?>">		
													<table class="table table-hover">
														<thead>
															
															<tr>
																<th>COUNTRY NAME</th>
<th><input name="txtcityname" value="<?= $citydata[0]->CityName?>"></th>
																<th align="center">
