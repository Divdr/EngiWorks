...
<form method="post" action="<?php echo site_url('admin/AdminCountry/updatecountrydata/'.$codata[0]->CountryID) ?>">		
													<table class="table table-hover">
														<thead>
															
															<tr>
																<th>COUNTRY NAME</th>
<th><input name="txtconame" value="<?= $codata[0]->CountryName?>"></th>
																<th align="center">
