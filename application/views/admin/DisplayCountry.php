					...
					<div class="pcoded-inner-content">
						...
						<div class="card">
											<div class="card-header" align="center">
												<h5 align="center">Countries</h5>
												
												<div class="card-header-right"> <ul class="list-unstyled card-option"> <li class="first-opt"><i class="feather icon-chevron-left open-card-option"></i></li> <li><i class="feather icon-maximize full-card"></i></li> <li><i class="feather icon-minus minimize-card"></i></li> <li><i class="feather icon-refresh-cw reload-card"></i></li> <li><i class="feather icon-trash close-card"></i></li> <li><i class="feather icon-chevron-left open-card-option"></i></li> </ul> </div>
											</div>
											<div class="card-block table-border-style">
												<div class="table-responsive">
													<form method="post" action="<?php echo site_url("admin/AdminCountry/insertcountrypage/")?>">
...
<tr>															
																<th><?= $cd->CountryName  ?></th>
<th><a href="<?php echo site_url('admin/AdminState/displaystate/'.$cd->CountryID)?>">View States</a></th>
<!-- 
	<th><a href="<?php echo site_url('admin/AdminCountry/deletecountry/'.$cd->CountryID )?>">DELETE</a></th> -->

<th><a href="<?php echo site_url('admin/AdminCountry/getcountryID/'.$cd->CountryID )?>">UPDATE</a></th>																
...
<th colspan="5">
	<div class="row m-t-30">
		<div class="col-md-12">
			<input type="submit" name="button" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-10" value="Insert Country">
		</div>
	</div>
</th>				
														</tbody>
