...
<form method="post" action="<?php echo site_url('admin/admin/insertcat/') ?>">		
													<table class="table table-hover">
														<thead>
															
															<tr>
																<th>CATEGORY NAME</th>
<th><input name="txtname" placeholder="Enter Category Name"></th>
															<tr>
																<th>STATUS</th>
<th><input name="txtstatus" placeholder="Enter Category Status"></th>
