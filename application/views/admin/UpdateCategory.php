...
<form method="post" action="<?php echo site_url('admin/admin/updatedata/'.$catdata[0]->CategoryID) ?>">		
													<table class="table table-hover">
														<thead>
															
															<tr>
																<th>CATEGORY NAME</th>
<th><input name="txtname" value="<?= $catdata[0]->CategoryName ?>"></th>
															<tr>
																<th>STATUS</th>
<th><input name="txtstatus" value="<?= $catdata[0]->Status ?>"></th>
