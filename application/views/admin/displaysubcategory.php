				...
				<div class="pcoded-content">
					...
					<div class="pcoded-inner-content">
											...
											<div class="card-header" align="center">
												<h5 align="center">Sub-Categories</h5>
												
												<div class="card-header-right"> <ul class="list-unstyled card-option"> <li class="first-opt"><i class="feather icon-chevron-left open-card-option"></i></li> <li><i class="feather icon-maximize full-card"></i></li> <li><i class="feather icon-minus minimize-card"></i></li> <li><i class="feather icon-refresh-cw reload-card"></i></li> <li><i class="feather icon-trash close-card"></i></li> <li><i class="feather icon-chevron-left open-card-option"></i></li> </ul> </div>
											</div>
											<div class="card-block table-border-style">
												<div class="table-responsive">
													<form method="post" action="<?php echo site_url("admin/SubCategory/InsertPageSubCat/").$CategoryID ?>">
													<table class="table table-hover">
														...
														<tbody>
														<?php
															foreach ($SkillName as $sn) 
															{
														?>
															<tr>
																<td><?php echo $sn->SkillName ?></td>
<td>
	<a href="<?= site_url('admin/SubCategory/toggalstatus/') .$sn->SkillID."/".$sn->Status."/".$sn->CategoryID ?>">
	<?php
	if ($sn->Status==0) 
	{
		echo "ACTIVE";
...
<th><a href="<?php echo site_url('admin/SubCategory/deleteSubCatData/'.$sn->SkillID )?>">DELETE</a></th>

<th><a href="<?php echo site_url('admin/SubCategory/LoadSubCatUpdateData/'.$sn->SkillID )?>">UPDATE</a></th>
...
<th colspan="7">
	<div class="row m-t-30">
		<div class="col-md-12">
			<input type="submit" name="button" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-10" value="INSERT CATEGORY">
		</div>
	</div>
</th>				
														</tbody>
