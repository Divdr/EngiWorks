					...
					<div class="pcoded-inner-content">
						...
						<div class="card">
											<div class="card-header" align="center">
												<h5 align="center">States</h5>
												
												<div class="card-header-right"> <ul class="list-unstyled card-option"> <li class="first-opt"><i class="feather icon-chevron-left open-card-option"></i></li> <li><i class="feather icon-maximize full-card"></i></li> <li><i class="feather icon-minus minimize-card"></i></li> <li><i class="feather icon-refresh-cw reload-card"></i></li> <li><i class="feather icon-trash close-card"></i></li> <li><i class="feather icon-chevron-left open-card-option"></i></li> </ul> </div>
											</div>
											<div class="card-block table-border-style">
												<div class="table-responsive">
													<form method="post" action="<?php echo site_url("admin/AdminState/insertpage/").$CountryID?>">
													<table class="table table-hover">
														...
														<tbody>
															...
															<tr>															
																<th><?= $s->StateName ?></th>
																<th><a href="<?= site_url("admin/AdminCity/displaycity/".$s->StateID)?>">View Cities</a></th>


																<th><a href="<?php echo site_url('admin/AdminState/GetStateByID/'.$s->StateID )?>">UPDATE</a></th>																
															...
															<th colspan="5">
																<div class="row m-t-30">
																	<div class="col-md-12">
																		<input type="submit" name="button" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-10" value="Insert State">
																	</div>
																</div>
															</th>				
														</tbody>
